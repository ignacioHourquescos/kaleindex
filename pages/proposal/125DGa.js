...
import pp from '../../dataProposal/DGArte'
               ...
               <div className={ss.container_detail}>
                  {
                     page1[0] ?
                        <div className={ss.bienvenidos}>
                           <h3> </h3>
                           <br/>
                           <div>Nos alegra que nos hayas tenido en cuenta!</div>
                           <br/>
                           <div>Aca podrás conocer la propuesta del proyecto con las etapas y valores.</div>
                           <br/>
                           {pp.Bienvenidos}
                           <br/>
                           <br/>
