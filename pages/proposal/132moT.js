...
import pp from '../../dataProposal/mot'
               ...
               {pp.ustedes}  */}
                        ...
                        : page1[1] ?
                           <div>
                              <h3>Alcance</h3>
                              {pp.alcance.resumen}
                              <h3>Detalle (Primeros 3 meses)</h3>
                           ...
                           //    </div>
                              : page1[3] ?
                                 <div>
                                    ...
                                    <div style={{backgroundColor:"#bef4cb",fontWeight:"bold", color:"black",marginTop:"2em", padding:"0.5rem"}}> Presupuesto Mensual (Primeros 3 meses): ${pp.presupuesto.valor} pesos</div>
                                    <h3>Detalle</h3>
                                    <li>Manejo de redes: $20.000</li>
                                    <li>Cuotas desarrollo web $15.000</li>
