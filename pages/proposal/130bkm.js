      ...
      </Head>
      {
         showIntro
            ...
            <div className={ss.intro}>
               ...
               <button ><Link href="https://www.hsrabogados.com">ULTIMO TRABAJO</Link></button>
               <button style={{border:"2px solid #3CCD9D", color:"#3CCD9D"}}><Link href="/">OTROS TRABAJOS</Link></button>
            </div>
            :
